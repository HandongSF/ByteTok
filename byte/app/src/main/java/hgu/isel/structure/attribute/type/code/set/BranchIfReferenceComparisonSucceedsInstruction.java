...
public class BranchIfReferenceComparisonSucceedsInstruction implements Instruction {
    private byte format;
    private byte branchByte1;
    private byte branchByte2;

    public BranchIfReferenceComparisonSucceedsInstruction(byte format, byte branchByte1, byte branchByte2) {
        this.format = format;
    ...
    public List<String> tokenize() {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("[Branch If Reference Comparison Succeeds Instruction] ");
        stringBuilder.append(String.format("%02X", format));
        stringBuilder.append(String.format("%02X", branchByte1));
        stringBuilder.append(String.format("%02X", branchByte2));
