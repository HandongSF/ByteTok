...
public class CheckObjectTypeInstruction implements Instruction {
    private byte format;
    private byte indexByte1;
    private byte indexByte2;

    public CheckObjectTypeInstruction(byte format, byte indexByte1, byte indexByte2) {
        this.format = format;
    ...
    public List<String> tokenize() {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("[Check Object Type Instruction] ");
        stringBuilder.append(String.format("%02X", format));
        stringBuilder.append(String.format("%02X", indexByte1));
        stringBuilder.append(String.format("%02X", indexByte2));
