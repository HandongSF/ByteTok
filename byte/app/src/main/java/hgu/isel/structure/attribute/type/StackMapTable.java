...
public class StackMapTable implements AttributeInformation {
    ...
    public List<String> tokenize() {
        ...
        stringBuilder.append("[Stack Map Table Attribute Name Index] ");
        for(byte b : attributeNameIndex) {
            stringBuilder.append(String.format("%02X", b));
        }
        ...
        stringBuilder.append("[Stack Map Table Attribute Length] ");
        for(byte b : attributeLength) {
            stringBuilder.append(String.format("%02X", b));
        }
        output.add(stringBuilder.toString());
        ...
        stringBuilder.append("[Stack Map Table Attribute Entry Number] ");
        for(byte b : numberOfEntries) {
            stringBuilder.append(String.format("%02X", b));
        }
        output.add(stringBuilder.toString());
