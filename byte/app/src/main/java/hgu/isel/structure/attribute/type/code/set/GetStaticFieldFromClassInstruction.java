...
public class GetStaticFieldFromClassInstruction implements Instruction {
    private byte format;
    private byte indexByte1;
    private byte indexByte2;

    public GetStaticFieldFromClassInstruction(byte format, byte indexByte1, byte indexByte2) {
        this.format = format;
